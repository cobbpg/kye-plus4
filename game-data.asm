...
.const InGameCharacters = 86
.const DiamondFrameCount = 6
...
.function GetBitmapChroma(ink, paper) {
	.return (paper & $0f) | (ink << 4)
}

.function GetBitmapLuma(ink, paper) {
	.return (paper & $f0) | (ink >> 4)
}